...
select * from review v left join reviewReply r 
on part = 'pds' and v.partIdx = 5 and v.idx=r.reviewIdx where v.partIdx=5;

select * from (select *from review where partIdx = 5) v left join reviewReply r 
on part = 'pds' and v.partIdx = 5 and v.idx=r.reviewIdx;

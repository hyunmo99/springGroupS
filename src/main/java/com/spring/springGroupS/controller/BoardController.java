...
public class BoardController {
	...
	public String boardContentGet(Model model, int idx, HttpSession session, String boardFlag, PageVO pageVO) {
		// 조회수 증가하기
	...
	public String boardUpdateGet(Model model, int idx, PageVO pageVO) {
		BoardVO vo = boardService.getBoardContent(idx);
	...
	public String boardDeleteGet(Model model, int idx, PageVO pageVO) {
	...
	public String boardSearchListPost(Model model, PageVO pageVO) {
		pageVO.setSection("board");
		pageVO = pagenation.pagenation(pageVO);
		List<BoardVO> vos = boardService.getBoardList(pageVO.getStartIndexNo(), pageVO.getPageSize(), pageVO.getSearch(), pageVO.getSearchString());

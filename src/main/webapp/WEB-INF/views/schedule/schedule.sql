...
select *from schedule where mid='hkd1234' and sDate = '2025-09-14' order by sDate; /*O*/
select *from schedule where mid='hkd1234' and sDate = date_format('2025-09', '%Y-%m') order by sDate; /*삼각형*/
...
select substring(sDate, 1, 7) from schedule; /**/

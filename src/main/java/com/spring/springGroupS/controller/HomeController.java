...
public class HomeController {
	...
	public String home(Locale locale, Model model) {
		...
		logger.info("info  : home! The client locale is {}.", locale);
//		logger.warn("warn  : home! The client locale is {}.", locale);
//		logger.error("error: home! The client locale is {}.", locale);
//		logger.debug("debug: home! The client locale is {}.", locale);
//		System.out.println("===================================");

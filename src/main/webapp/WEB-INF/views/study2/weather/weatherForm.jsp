...
<head>
  ...
  <script>
    ...
    $.getJSON('https://api.openweathermap.org/data/2.5/weather?q=Seoul,kr&appid=05ebe68de9c2b057dbc5ec55d5553efb&units=metric',
   		function (res) {
    ...
    //현재 지역(브라우저상)의 날씨 보여주기
	    ...
	    $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat='+position.coords.latitude+'&lon='+position.coords.longitude+'&appid=05ebe68de9c2b057dbc5ec55d5553efb&units=metric',
  	    function (res) {
	    	  $(".dispForm2").show();
    ...
    // DB에서 지역을 찾아서 그 위치의 날씨를 출력처리
	    ...
	    $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat='+positionObj.latitude+'&lon='+positionObj.longitude+'&appid=05ebe68de9c2b057dbc5ec55d5553efb&units=metric',
  	    function (res) {
	    	  $(".dispForm3").show();

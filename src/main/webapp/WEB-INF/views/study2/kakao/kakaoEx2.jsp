...
<div class="container">
  ...
  <form name="myform">
    ...
    mapOption = { 
        center: new kakao.maps.LatLng(36.635007192648985, 127.45951222020699), // 지도의 중심좌표
        level: 3 // 지도의 확대 레벨
    };
	...
	kakao.maps.event.addListener(map, 'click', function(mouseEvent) {        
	    ...
	    message += '경도는 ' + latlng.getLng() + ' 입니다';
	   	...
	   	message += '<input type="button" value="DB저장" onclick="addressSave('+latlng.getLat()+', '+latlng.getLng()+')" class="btn btn-success btn-sm"/></p>';
	   	message += '';
	   	message += '';

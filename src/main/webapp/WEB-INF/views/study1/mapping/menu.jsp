...
<div class="container">
  ...
  <p>
  	...
  	<a href="test7?mid=ohn1234&pwd=2468&name=고인돌&gender=남자&age=66" class="btn btn-outline-primary">test7</a>
  	<a href="test8?mid=atom1234&pwd=0987&name=아톰&gender=충성&age=12" class="btn btn-outline-secondary">test8</a>
  	<a href="test9?mid=atom1234&pwd=0987&name=비톰&gender=충성&age=12" class="btn btn-outline-secondary">test9</a>
  </p>
  ...
  <p>
  	...
  	<a href="test22/hms1234/5678" class="btn btn-primary">test22</a>
  	<a href="1357/test23/lkj1234" class="btn btn-secondary">test23</a>
  	<a href="2468/_____/test24/ohn1234" class="btn btn-info">test24</a>
  	<a href="test25/atom1234/0987/비톰/___/남자/44" class="btn btn-outline-secondary">test25</a>
  </p>

...
@Override
	...
	public List<CrimeVO> getDbListCrimeCheck(int year) {
		return study2DAO.getDbListCrimeCheck(year);
	}
	
	@Override
	public List<CrimeVO> getDataApiForm1(int year, String policeZone) {
		return study2DAO.getDataApiForm1(year, policeZone);
	}
